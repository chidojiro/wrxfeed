...
(self['webpackChunkgravity_web'] = self['webpackChunkgravity_web'] || []).push([
  ['src_auth_pages_AcceptInvitation_index_tsx'],
  {
    /***/ './src/auth/pages/AcceptInvitation/index.tsx':
      /*!***************************************************!*\
  !*** ./src/auth/pages/AcceptInvitation/index.tsx ***!
  \***************************************************/
      /***/ function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ AcceptInvitationPage: function () {
            return /* binding */ AcceptInvitationPage;
          },
          /* harmony export */
        });
        ...
        /* harmony import */ var _error_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! @/error/utils */ './src/error/utils.ts',
        );
        /* harmony import */ var _invitation_apis__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(/*! @/invitation/apis */ './src/invitation/apis.ts');
        /* harmony import */ var _routing_routes__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
        ...
        var QUERY_ID = 'inviteId';
        var ErrorCode;
        (function (ErrorCode) {
          ErrorCode[(ErrorCode['UNKNOWN'] = 1)] = 'UNKNOWN';
          ErrorCode[(ErrorCode['SUCCESS'] = 200)] = 'SUCCESS';
          ErrorCode[(ErrorCode['INVALID_REQUEST'] = 400)] = 'INVALID_REQUEST';
          ErrorCode[(ErrorCode['NOT_FOUND'] = 404)] = 'NOT_FOUND';
          ErrorCode['INV_INVITATION_ALREADY_ACCEPTED'] = 'INV_INVITATION_ALREADY_ACCEPTED';
          ErrorCode['INV_INVITATION_EXPIRED'] = 'INV_INVITATION_EXPIRED';
        })(ErrorCode || (ErrorCode = {}));
        var AcceptInvitationPage = function AcceptInvitationPage() {
          var query = (0, _common_hooks__WEBPACK_IMPORTED_MODULE_1__.useLegacyQuery)();
          var router = (0, react_router_dom__WEBPACK_IMPORTED_MODULE_6__.useHistory)();
          ...
          var acceptInvitationRequest = (0, react__WEBPACK_IMPORTED_MODULE_5__.useCallback)(
            /*#__PURE__*/ _asyncToGenerator(
              /*#__PURE__*/ _regeneratorRuntime().mark(function _callee() {
                var inviteId, result, _err$details, _ref2, errorDetail;
                return _regeneratorRuntime().wrap(
                  function _callee$(_context) {
                    while (1)
                      switch ((_context.prev = _context.next)) {
                        case 0:
                          inviteId = query.get(QUERY_ID);
                          if (inviteId) {
                            _context.next = 6;
                            break;
                          }
                        ...
                        case 6:
                          _context.prev = 6;
                          _context.next = 9;
                          return _invitation_apis__WEBPACK_IMPORTED_MODULE_3__.InvitationApis.accept(
                            inviteId,
                          );
                        case 9:
                          ...
                          // Redirect to login
                          router.replace(
                            _routing_routes__WEBPACK_IMPORTED_MODULE_4__.Routes.Login.path,
                            {
                              fromInvite: true,
                        ...
                        case 13:
                          ...
                          if (
                            !(0, _error_utils__WEBPACK_IMPORTED_MODULE_2__.isApiError)(_context.t0)
                          ) {
                            _context.next = 26;
                            break;
                          }
                          (_ref2 =
                            (_err$details = _context.t0.details) !== null && _err$details !== void 0
                              ? _err$details
                              : {}),
                            (errorDetail = _ref2.error);
                          _context.t1 = _context.t0.code;
                          _context.next =
                            _context.t1 === ErrorCode.INVALID_REQUEST.valueOf()
                              ? 20
                              : _context.t1 === ErrorCode.NOT_FOUND.valueOf()
                              ? 22
                              : 24;
                          break;
                        case 20:
          ...
          return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_5__.createElement(
            ...
            (error === null || error === void 0 ? void 0 : error.code) ===
              ErrorCode.INV_INVITATION_ALREADY_ACCEPTED &&
              /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_5__.createElement(
                react_router_dom__WEBPACK_IMPORTED_MODULE_7__.Link,
                {
                  to: '/login',
                  className:
                    'my-5 px-5 py-2 bg-Gray-2 text-base text-white shadow-sm rounded-sm disabled:bg-Gray-6',
                },
                'Sign In',
              ),
          );
...
//# sourceMappingURL=src_auth_pages_AcceptInvitation_index_tsx.bundle.js.map
