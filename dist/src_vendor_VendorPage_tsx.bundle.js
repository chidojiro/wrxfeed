...
(self['webpackChunkgravity_web'] = self['webpackChunkgravity_web'] || []).push([
  ...
  \*************************************/
      /***/ function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ VendorHeader: function () {
            return /* binding */ VendorHeader;
          },
          /* harmony export */
        });
        ...
        /* harmony import */ var _useVendor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ./useVendor */ './src/vendor/useVendor.ts',
        );

        var VendorHeader = function VendorHeader(_ref) {
          var className = _ref.className,
            vendorId = _ref.vendorId;
          var VendorHeaderColor = (0, _main_utils__WEBPACK_IMPORTED_MODULE_3__.getColorByText)(
            '',
            vendorId,
            true,
          );
          var _useVendor = (0, _useVendor__WEBPACK_IMPORTED_MODULE_4__.useVendor)(vendorId),
            department = _useVendor.data;
          return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1__.createElement(
            ...
            /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1__.createElement(
              ...
              /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1__.createElement(
                ...
                /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_1__.createElement(
                  _assets__WEBPACK_IMPORTED_MODULE_2__.VendorIcon,
                  {
  ...
  \***********************************/
      /***/ function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ VendorPage: function () {
            return /* binding */ VendorPage;
          },
          /* harmony export */
        });
        /* harmony import */ var _assets__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        ...
        /* harmony import */ var _layout_MainLayout__WEBPACK_IMPORTED_MODULE_7__ =
        ...
        /* harmony import */ var _mixpanel_useMixPanel__WEBPACK_IMPORTED_MODULE_9__ =
          __webpack_require__(/*! @/mixpanel/useMixPanel */ './src/mixpanel/useMixPanel.ts');
        /* harmony import */ var _profile_useProfile__WEBPACK_IMPORTED_MODULE_10__ =
          __webpack_require__(/*! @/profile/useProfile */ './src/profile/useProfile.ts');
        /* harmony import */ var _spending_GroupedSpendingChart__WEBPACK_IMPORTED_MODULE_11__ =
          __webpack_require__(
            /*! @/spending/GroupedSpendingChart */ './src/spending/GroupedSpendingChart.tsx',
          );
        /* harmony import */ var _spending_GroupedSpendingChartLegends__WEBPACK_IMPORTED_MODULE_12__ =
          __webpack_require__(
            /*! @/spending/GroupedSpendingChartLegends */ './src/spending/GroupedSpendingChartLegends.tsx',
          );
        /* harmony import */ var _spending_SpendingBarChart__WEBPACK_IMPORTED_MODULE_13__ =
          __webpack_require__(
            /*! @/spending/SpendingBarChart */ './src/spending/SpendingBarChart.tsx',
          );
        /* harmony import */ var _spending_utils__WEBPACK_IMPORTED_MODULE_14__ =
          __webpack_require__(/*! @/spending/utils */ './src/spending/utils.ts');
        /* harmony import */ var _team_constants__WEBPACK_IMPORTED_MODULE_15__ =
          __webpack_require__(/*! @/team/constants */ './src/team/constants.ts');
        /* harmony import */ var _transactions_TransactionList__WEBPACK_IMPORTED_MODULE_16__ =
          __webpack_require__(
            /*! @/transactions/TransactionList */ './src/transactions/TransactionList/index.tsx',
          );
        /* harmony import */ var _transactions_useTransactions__WEBPACK_IMPORTED_MODULE_17__ =
          __webpack_require__(
        ...
        /* harmony import */ var _useVendor__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
          /*! ./useVendor */ './src/vendor/useVendor.ts',
        );
        /* harmony import */ var _useVendorSpendings__WEBPACK_IMPORTED_MODULE_21__ =
          __webpack_require__(/*! ./useVendorSpendings */ './src/vendor/useVendorSpendings.ts');
        /* harmony import */ var _VendorHeader__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
          /*! ./VendorHeader */ './src/vendor/VendorHeader.tsx',
        );
        ...
        var VendorPage = function VendorPage() {
          ...
          var _useUrlState = (0, _common_hooks__WEBPACK_IMPORTED_MODULE_4__.useUrlState)(
              'sortTransactionsBy',
              _team_constants__WEBPACK_IMPORTED_MODULE_15__.DEFAULT_SORT,
            ),
            _useUrlState2 = _slicedToArray(_useUrlState, 2),
            sortTransactionsBy = _useUrlState2[0],
            setSortTransactionsBy = _useUrlState2[1];
          var _React$useState3 = react__WEBPACK_IMPORTED_MODULE_19__.useState('year-to-date'),
            _React$useState4 = _slicedToArray(_React$useState3, 2),
            dateRange = _React$useState4[0],
            setDateRange = _React$useState4[1];
          var _React$useState5 = react__WEBPACK_IMPORTED_MODULE_19__.useState(undefined),
            _React$useState6 = _slicedToArray(_React$useState5, 2),
            groupBy = _React$useState6[0],
            setGroupBy = _React$useState6[1];
          var _ref = (0, react_router_dom__WEBPACK_IMPORTED_MODULE_23__.useParams)(),
            vendorIdParam = _ref.vendorId;
          var vendorId = +vendorIdParam;
          var _React$useState7 = react__WEBPACK_IMPORTED_MODULE_19__.useState(1),
            _React$useState8 = _slicedToArray(_React$useState7, 2),
            page = _React$useState8[0],
            setPage = _React$useState8[1];
          var _useVendor = (0, _useVendor__WEBPACK_IMPORTED_MODULE_20__.useVendor)(vendorId, {
              onError: function onError(error) {
                if (error.code === _error__WEBPACK_IMPORTED_MODULE_6__.ApiErrorCode.Forbidden) {
                  return false;
                }
              },
            }),
            vendor = _useVendor.data,
            isValidatingVendor = _useVendor.isValidating,
            error = _useVendor.error;
          var _useVendorSpendings = (0,
            _useVendorSpendings__WEBPACK_IMPORTED_MODULE_21__.useVendorSpendings)(
              vendorId,
              _objectSpread(
                {
                  groupBy: groupBy,
                },
                (0, _spending_utils__WEBPACK_IMPORTED_MODULE_14__.convertDateRangeToFromTo)({
                  dateRange: 'year-to-date',
                }),
              ),
            ),
            vendorSpendings = _useVendorSpendings.vendorSpendings,
            curYearSpends = _useVendorSpendings.curYearSpends,
            prevYearSpends = _useVendorSpendings.prevYearSpends,
            isValidatingVendorSpendings = _useVendorSpendings.isValidatingVendorSpendings;
          var _useTransactions = (0,
            _transactions_useTransactions__WEBPACK_IMPORTED_MODULE_17__.useTransactions)(
              _objectSpread(
                _objectSpread(
                  {
                    props: [
          ...
          var _useProfile = (0, _profile_useProfile__WEBPACK_IMPORTED_MODULE_10__.useProfile)(),
            profile = _useProfile.profile;
          (0, _common_hooks__WEBPACK_IMPORTED_MODULE_4__.useMountEffect)(function () {
            var _profile$company;
            mixpanel_browser__WEBPACK_IMPORTED_MODULE_18___default().track('Vendor Page View', {
            ...
            (0,
            _mixpanel_useMixPanel__WEBPACK_IMPORTED_MODULE_9__.identifyMixPanelUserProfile)(profile);
          });
          ...
          if (isForbidden) {
            return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_19__.createElement(
              _layout_MainLayout__WEBPACK_IMPORTED_MODULE_7__.MainLayout,
              null,
          ...
          return /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_19__.createElement(
            ...
            null,
            /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_19__.createElement(
              _VendorHeader__WEBPACK_IMPORTED_MODULE_22__.VendorHeader,
              {
                vendorId: vendorId,
              },
            ),
            /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_19__.createElement(
              ...
              {
                loading: isValidatingVendor || isValidatingVendorSpendings,
                className: 'mt-6',
              },
              /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_19__.createElement(
                'div',
                ...
                /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_19__.createElement(
                  ...
                  /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_19__.createElement(
                    ...
                    /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_19__.createElement(
                      ...
                      (0, _main_utils__WEBPACK_IMPORTED_MODULE_8__.getDisplayUsdAmount)(totalSpend),
                    ),
                  ),
                  /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_19__.createElement(
                    'div',
                    ...
                    /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_19__.createElement(
                      ...
                      (0, _main_utils__WEBPACK_IMPORTED_MODULE_8__.getDisplayUsdAmount)(
                        totalSpendLastYear,
                      ),
                    ),
                  ),
                ...
                /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_19__.createElement(
                  ...
                  /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_19__.createElement(
                    ...
                    !groupBy
                      ? /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_19__.createElement(
                          _spending_SpendingBarChart__WEBPACK_IMPORTED_MODULE_13__.SpendingBarChart,
                          {
                      ...
                      : /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_19__.createElement(
                          _spending_GroupedSpendingChart__WEBPACK_IMPORTED_MODULE_11__.GroupedSpendingChart,
                          {
                  ...
                  !!groupBy &&
                    /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_19__.createElement(
                      _spending_GroupedSpendingChartLegends__WEBPACK_IMPORTED_MODULE_12__.GroupedSpendingChartLegends,
                      {
            ...
            /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_19__.createElement(
              _transactions_TransactionList__WEBPACK_IMPORTED_MODULE_16__.TransactionList,
              {
                className: 'mt-6',
  ...
  \*********************************/
      /***/ function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ useVendor: function () {
            return /* binding */ useVendor;
          },
          /* harmony export */
        });
        ...
        var useVendor = function useVendor(id, options) {
          return (0, _common_hooks__WEBPACK_IMPORTED_MODULE_0__.useFetcher)(
            ['vendor', id],
            function () {
              return _apis__WEBPACK_IMPORTED_MODULE_1__.VendorApis.get(id);
            },
            options,
          );
        };
    ...
    /***/ './src/vendor/useVendorSpendings.ts':
      /*!******************************************!*\
  !*** ./src/vendor/useVendorSpendings.ts ***!
  \******************************************/
      /***/ function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ useVendorSpendings: function () {
            return /* binding */ useVendorSpendings;
          },
          /* harmony export */
        });
        /* harmony import */ var _common_hooks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        ...
        var useVendorSpendings = function useVendorSpendings(id, params) {
          var _useFetcher = (0, _common_hooks__WEBPACK_IMPORTED_MODULE_0__.useFetcher)(
              ['useVendorSpendings', id, params],
              function () {
                return _apis__WEBPACK_IMPORTED_MODULE_3__.VendorApis.getSpendings(id, params);
              },
              {
                laggy: true,
              },
...
//# sourceMappingURL=src_vendor_VendorPage_tsx.bundle.js.map
