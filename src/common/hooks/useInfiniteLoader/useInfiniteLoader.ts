...
export type UseInfiniteLoaderProps<T> =
  | UseOnDemandInfiniteLoaderProps<T>
  | UseOnSightInfiniteLoaderProps<T>;

type BaseUseInfiniteLoaderReturn = { isExhausted: boolean };
type UseOnDemandInfiniteLoaderReturn = BaseUseInfiniteLoaderReturn &
  BaseUseOnDemandInfiniteLoaderReturn;
type UseOnSightInfiniteLoaderReturn = BaseUseInfiniteLoaderReturn &
  BaseUseOnSightInfiniteLoaderReturn;
export type UseInfiniteLoaderReturn = UseOnDemandInfiniteLoaderReturn &
  UseOnSightInfiniteLoaderReturn;

export function useInfiniteLoader<TData>(
  props: UseInfiniteLoaderProps<TData>,
