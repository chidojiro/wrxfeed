import React, { ChangeEvent, KeyboardEvent, useImperativeHandle } from 'react';
...
const CommentInput = React.ForwardRefRenderFunction<CommentInputHandle, CommentInputProps>(
  ({ name, value, placeholder, onChange, onBlur, onEnterPress, onMention }, ref) => {
