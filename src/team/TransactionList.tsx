...
export const TransactionList = ({ className }: TransactionListProps) => {
  ...
  const renderTransListOrEmptyState = () => {
    // empty state
          ...
          <Table.Cell colSpan={7}>
            <div className="flex flex-1 py-4 px-2 w-full">
              <div className="flex flex-1 flex-col space-y-1 h-[200px] bg-Gray-12 rounded-card justify-center items-center">
                <p className="text-sm font-bold text-primary">No recent transactions</p>
                <p className="text-2sm text-Gray-6">
                  This will change as more transactions come in.
                </p>
              </div>
            </div>
          </Table.Cell>
