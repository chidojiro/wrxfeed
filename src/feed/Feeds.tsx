...
import { withOnRemountRequest, WithOnRemountRequestProps } from '@/common/hocs';
...
export const Feeds = withOnRemountRequest(
  ({
    departmentId,
    forYou,
    categoryId,
    ...
    onRemountRequest,
  }: FeedsProps & WithOnRemountRequestProps) => {
    ...
    return (
      <div>
        <NewFeedIndicator onScrollToTopComplete={onRemountRequest} />
        <LineItemDrawer
