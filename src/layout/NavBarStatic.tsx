  ...
  const renderInviteButton = () => {
    ...
    return (
      <Button
        ...
        className={clsx(
          hoverStyle,
          'ml-8 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white',
        )}
      >
        <UserPlusIcon className="flex mr-2" />
        Invite
      </Button>
    );
  };
          ...
          <div className="mx-auto max-w-3xl md:max-w-[1440px]">
            <div className="relative flex justify-between h-navbar md:grid md:grid-cols-12">
              ...
              <div className="flex items-center md:absolute md:right-0 md:inset-y-0 sm:hidden">
                <Popover.Button className="-mx-2 rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:bg-gray-100 hover:text-gray-500">
